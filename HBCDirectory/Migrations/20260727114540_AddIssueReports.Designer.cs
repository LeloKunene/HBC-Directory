...
namespace HBCDirectory.Migrations
{
    ...
    [Migration("20260727114540_AddIssueReports")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HBCDirectory.Models.ApprovalSettings", b =>
                {
                    ...
                    b.Property<bool>("RequireApprovalForAnniversary")
                        .HasColumnType("boolean");

                    b.Property<bool>("RequireApprovalForBirthdate")
                        .HasColumnType("boolean");

                    b.Property<bool>("RequireApprovalForDateJoined")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("HBCDirectory.Models.GroupLeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HBCDirectory.Models.IssueReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int?>("ReportedByMemberId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HBCDirectory.Models.MemberRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HBCDirectory.Models.PdfSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PdfSettings");
                });

            modelBuilder.Entity("HBCDirectory.Models.PendingFamilyPhoto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HBCDirectory.Models.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HBCDirectory.Models.IssueReport", b =>
                {
                    b.HasOne("HBCDirectory.Models.Member", "ReportedByMember")
                        .WithMany()
                        .HasForeignKey("ReportedByMemberId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("ReportedByMember");
                });
            ...
            modelBuilder.Entity("HBCDirectory.Models.MemberRole", b =>
                {
                    ...
                    b.HasOne("HBCDirectory.Models.Role", "Role")
